...
if (isset($_POST["tambah"])) {
  ...
  if (tambah_divisi($_POST) > 0) {
    echo "<script>
    alert('Divisi Berhasil di Tambah')
	document.location.href = 'divisi.php';
	</script>";
  } else {
    echo "<script>alert('Divisi Gagal di Tambah');
	</script>";
  }
}
?>
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <input type="text" class="form-control" id="nama_divisi" aria-describedby="emailHelp" value="" name="nama_divisi" required>
              <br>
