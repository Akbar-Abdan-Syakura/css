...
$jumlahdata = 10;
$jumlahuser = count(tampil_aset("SELECT * FROM form_pengadaan WHERE active='1' "));
...
WHERE active ='1' ORDER BY id_pengadaan DESC LIMIT $awaldata, $jumlahdata");
    ...
    <div class="row">
          ...
          <ul class="nav flex-column">
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                <li><a class="nav-link active" href="pengadaan_requester.php"><span data-feather="plus-square" class="align-text-bottom" aria-current="page"></span> Pengadaan</a></li>
      ...
      <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
          <h1 class="h2">Daftar Pengajuan Pengadaan</h1>
        ...
        <a class="btn btn-outline-primary" role="button" href="tambah_pengadaan.php" style="margin-bottom: 8px"><i class="bi bi-plus-lg"></i> Tambah Pengajuan</a>
                ...
                foreach ($pengadaan as $pgd) : ?>
                  <tbody>
                    <tr>
                      ...
                      <td class="text-center"><?= sprintf("%03d", $pgd["id_pengadaan"]); ?><?= sprintf("%03d", $pgd["id_divisi"]); ?><?= date('Y', strtotime($pgd["tanggal_pengadaan"])); ?></td>
                      <td class="text-center"><?= $pgd["nama_aset"]; ?></td>
                      <td class="text-center"><?= $pgd["nama_divisi"]; ?></td>
                      <td class="text-center"><?= $pgd["qty"]; ?> <?= $pgd["satuan"]; ?></td>
                      <td class="text-center"><?= $pgd["tanggal_pengadaan"]; ?></td>
                      <td class="text-center"><b><?= $pgd["status"]; ?></b></td>
                      <td class="text-center">
                        <a class="btn btn-outline-warning" role="button" href="detail_pengadaan_requester.php?id_pengadaan=<?= $pgd["id_pengadaan"]; ?>"><i class="bi bi-list"></i></a>
                        <button type="button" class="btn btn-outline-danger" data-bs-toggle="modal" data-bs-target="#deleteModal<?= $pgd['id_pengadaan']; ?>"><i class="bi bi-trash3-fill"></i></button>
                      </td>
                    </tr>
                    <?php $no++; ?>

                    <!-- Modal Delete -->
                    <div class="modal fade" id="deleteModal<?= $pgd['id_pengadaan']; ?>" tabindex=" -1" aria-labelledby="hapusUsers" aria-hidden="true">
                      <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            Yakin akan Menghapus Pengajuan Pengadaan <b> <?= sprintf("%03d", $pgd["id_pengadaan"]); ?><?= sprintf("%03d", $pgd["id_divisi"]); ?><?= date('Y', strtotime($pgd["tanggal_pengadaan"])); ?> <?= $pgd["nama_aset"]; ?></b> ?
                          </div>
                          <div class="modal-footer">

                            <a class="btn btn-outline-danger" href="hapus_pengadaan.php?id_pengadaan=<?= $pgd["id_pengadaan"]; ?>"><i class='bi bi-trash3-fill'></i> Hapus</a>
