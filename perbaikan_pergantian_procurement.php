...
$perbaikan_pergantian = tampil_perbaikan_pergantian("SELECT form_perbaikan_pergantian.id_perbaikan_pergantian,divisi.nama_divisi,form_perbaikan_pergantian.id_aset,form_perbaikan_pergantian.jenis_pengajuan,aset.nama_aset,aset.merk,aset.type,form_perbaikan_pergantian.tanggal_pengajuan,form_perbaikan_pergantian.qty,form_perbaikan_pergantian.keterangan,satuan.satuan,form_perbaikan_pergantian.status_pengajuan
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td class="text-center">
                        <a class="btn btn-outline-warning" role="button" href="detail_perbaikan_pergantian_procurement.php?id_perbaikan_pergantian=<?= $ppg["id_perbaikan_pergantian"]; ?>"><i class="bi bi-list"></i></a>
                        <a class="btn btn-outline-success" role="button" href="ubah_perbaikan_pergantian.php?id_perbaikan_pergantian=<?= $ppg["id_perbaikan_pergantian"]; ?>"><i class="bi bi-pencil-square"></i></a>
                       </td>
                    </tr>
                    <?php $no++; ?>
