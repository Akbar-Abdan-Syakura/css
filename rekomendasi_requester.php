...
//  $aset = cari_rekomendasi_aset($_POST["textcari"]);
//}
?>
        ...
        <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
          <div class="position-sticky pt-3">
            <ul class="nav flex-column">
              ...
              <li class="nav-item">
                <a class="nav-link active" href="rekomendasi_requester.php?page=1">
                ...
                <table class="table table-bordered table-responsive">
                  ...
                  foreach ($aset as $ast) : ?>
                    ...
                    if ($bobot_harga_aset >= 100000 and $bobot_harga_aset <= 2500000) {
                      ...
                      $ast["bobot_harga"] = 3;
                    } elseif ($bobot_harga_aset > 10000000) {
                      $ast["bobot_harga"] = 4;
                    }
                    ?>
                    ...
                    $total = $ast["total"];
                    if ($total >= 0.80 || $ast["tanggal_habis"] < $hari_ini) {
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td class="text-center"><b><?= $ast["rekomendasi"]; ?></b></td>
