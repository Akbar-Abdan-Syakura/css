...
if (isset($_POST["tambah"])) {
    ...
    if (tambah_pengadaan($_POST) > 0) {
        echo "<script>alert('Pengajuan Pengadaan telah ditambah');
		document.location.href = 'pengadaan_requester.php';
		</script>";
    } else {
        echo "<script>alert('Pengajuan Pengadaan Gagal di Tambah');
        </script>";
    }
}
?>
            ...
            <div class="row">
                ...
                <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                        <h1 class="h2">Tambah Pengadaan</h1>
                        <div class="btn-toolbar mb-2 mb-md-0">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item active">Dashboard</a></li>
                                    <li class="breadcrumb-item active">Pengajuan Pengadaan</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Tambah Pengadaan</li>
                                </ol>
                            </nav>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <a href="pengadaan_requester.php" class="btn btn-outline-danger"><i class="bi bi-x-circle"></i> Cancel</a>
                        </div>
                    </div>
