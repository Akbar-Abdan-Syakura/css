...
if (isset($_POST["tambahaset"])) {
    ...
    if (tambah_aset($_POST) > 0) {
        echo "<script>alert('Aset telah ditambah');
                ...
                <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <input type="text" class="form-control" id="nama_aset" aria-describedby="emailHelp" value="" name="nama_aset" required>
                            <br>
                            <span id="namadivisi" class="form-text">Merk</span>
                            <input type="text" class="form-control" id="merk" aria-describedby="emailHelp" value="" name="merk" required>
                            <br>
                            <span id="namadivisi" class="form-text">Type</span>
                            <input type="text" class="form-control" id="type" aria-describedby="emailHelp" value="" name="type" required>
                            <br>
                            <span id="namadivisi" class="form-text">Serial Number</span>
                            <input type="text" class="form-control" id="serial_number" aria-describedby="emailHelp" value="" name="sn" required>
                            <br>
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" id="harga_aset" aria-describedby="emailHelp" value="" name="harga_aset" onkeypress="return event.charCode >= 48 && event.charCode <=57" required>
                            </div>
                            <br>
                            ...
                            <br>
                            <button type="submit" name="tambahaset" class="btn btn-outline-primary"><i class="bi bi-save"></i> tambah</button>
