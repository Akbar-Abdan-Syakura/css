                ...
                <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <input type="text" class="form-control" id="nama_aset" aria-describedby="emailHelp" value="<?= sprintf("%03d", $aset["id_aset"]); ?><?= sprintf("%03d", $aset["id_divisi"]); ?><?= date('Y', strtotime($aset["tanggal_masuk"])); ?>" name="id_aset" readonly>
                            <br>
                            ...
                            <br>
                            <span id="kondisi" class="form-text">Kondisi Aset</span>
                            <input type="text" class="form-control" id="user" aria-describedby="emailHelp" value="<?= $aset["kondisi"]; ?>" name="kondisi" readonly>
                            <br>
                            ...
                            <br>
                            <a href="monitoring_procurement.php" class="btn btn-outline-danger"><i class="bi bi-arrow-counterclockwise"></i> Back</a>
                        </div>
                    </div>
