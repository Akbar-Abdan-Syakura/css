                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a class="btn btn-outline-warning" role="button" href="detail_perbaikan_pergantian_admin.php?id_perbaikan_pergantian=<?= $ppg["id_perbaikan_pergantian"]; ?>"><i class="bi bi-list"></i></a>
                                                </td>
                                            </tr>
                                            <?php $no++; ?>
