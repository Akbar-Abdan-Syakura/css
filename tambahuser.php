...
if (isset($_POST["register"])) {
  ...
  if (registrasi($_POST) > 0) {
    echo "<script>alert('user telah ditambah');
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <input type="text" class="form-control" id="username" aria-describedby="emailHelp" value="" name="username" required>
              <br>
              <span id="namadivisi" class="form-text">Password</span>
              <input type="password" class="form-control" id="password" aria-describedby="emailHelp" value="" name="password" required>
              <br>
              <span id="namadivisi" class="form-text">Confirm Password</span>
              <input type="password" class="form-control" id="password2" aria-describedby="emailHelp" value="" name="password2" required>
              <br>
              <span id="namadivisi" class="form-text">Nama</span>
              <input type="text" class="form-control" id="name" aria-describedby="emailHelp" value="" name="name" required>
              <br>
              ...
              <br>
              <button type="submit" name="register" class="btn btn-outline-primary"><i class="bi bi-save"></i> tambah</button>
