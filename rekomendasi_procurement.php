...
$jumlahdata = 10;
$hari_ini = date('Y-m-d');
$jumlahuser = count(tampil_aset("SELECT * FROM aset
...
WHERE (aset.id_kondisi_aset = 3 OR aset.id_kondisi_aset = 4
OR aset.tanggal_habis < '$hari_ini')
AND status_aset ='1'"));
...
WHERE (aset.id_kondisi_aset = 3 OR aset.id_kondisi_aset = 4
OR aset.tanggal_habis < '$hari_ini')
AND status_aset ='1' ORDER BY id_aset DESC LIMIT $awaldata, $jumlahdata");
            ...
            <div class="row">
                <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
                    <div class="position-sticky pt-3">
                        <ul class="nav flex-column">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" href="rekomendasi_procurement.php?page=1">
                ...
                <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                        <h1 class="h2">Daftar Rekomendasi Aset</h1>
                        <div class="btn-toolbar mb-2 mb-md-0">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item active">Dashboard</a></li>
                                    <li class="breadcrumb-item active">Rekomendasi Aset</a></li>
                                </ol>
                            </nav>
                            ...
                            <div class="card-body">
                                <table class="table table-bordered table-responsive">
                                    ...
                                    foreach ($aset as $ast) : ?>
                                        ...
                                        $bobot_harga_aset = $ast["harga_aset"];

                                        if ($bobot_harga_aset >= 100000 and $bobot_harga_aset <= 2500000) {
                                            $ast["bobot_harga"] = 1;
                                        } elseif ($bobot_harga_aset > 2500000 and $bobot_harga_aset <= 5000000) {
                                            $ast["bobot_harga"] = 2;
                                        } elseif ($bobot_harga_aset > 6000000 and $bobot_harga_aset <= 10000000) {
                                            $ast["bobot_harga"] = 3;
                                        ...
                                        $total = $ast["total"];
                                        if ($total >= 0.8 || $ast["tanggal_habis"] < $hari_ini) {
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><?= $ast["kondisi"]; ?></td>
                                                <td><b><?= $ast["rekomendasi"]; ?></b></td>
                                                <td class="text-center"><b><?= $ast["alasan"]; ?></b></td>
