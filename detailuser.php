...
$user = tampil_user("SELECT * FROM users INNER JOIN divisi ON users.id_divisi = divisi.id_divisi WHERE id_users = $id_user")[0];
                ...
                <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <input type="text" class="form-control" id="username" aria-describedby="emailHelp" value="<?= $user["username"]; ?>" name="username" readonly>
                            <br>
                            <span id="namadivisi" class="form-text">Nama</span>
                            <input type="text" class="form-control" id="name" aria-describedby="emailHelp" value="<?= $user["nama"]; ?>" name="name" readonly>
                            <br>
                            <span id="namadivisi" class="form-text">Divisi</span>
                            <input type="text" class="form-control" id="nama_divisi" aria-describedby="emailHelp" value="<?= $user["nama_divisi"]; ?>" name="nama_divisi" readonly>
                            <br>
                            <span id="namadivisi" class="form-text">Role</span>
                            <input type="text" class="form-control" id="role" aria-describedby="emailHelp" value="<?= $user["role"]; ?>" name="role" readonly>
                            <br>
                            <a href="user.php" class="btn btn-outline-danger"><i class="bi bi-arrow-counterclockwise"></i> Back</a>
                        </div>
                    </div>
