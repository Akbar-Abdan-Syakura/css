...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  $sql = "select * from users where username='" . $username . "' AND passwords='" . SHA1($password) . "' limit 1";
  ...
  if ($jumlah > 0) {
    ...
    if ($_SESSION["role"] = $row["role"] == 1) {
      ...
      header("Location:dashboard_requester.php");
    } else if ($_SESSION["role"] = $row["role"] == 3) {
      header("Location:dashboard_procurement.php");
    }
  } else {
    $error = true;
  }
            ...
            <div class="card-body p-md-5 ">
              <div class="row justify-content-center">
                <div class="col-md-10 col-lg-5 col-xl-5 order-2 order-lg-1">
                  <p class="text-center h1 fw-bold mb-5 mx-1 mx-md-4 mt-4 text-danger">Login</p>
                  <!-- WARNING Username / Password Salah -->
                  <?php if (isset($error)) : ?>
                    <div class="d-flex flex-row align-items-center mb-2">
                      <span id="warning" class="form-text text-danger">Username atau Password Salah!</span>
                    </div>
                  <?php endif; ?>
                  <!-- END WARNING -->
                  <div class="d-flex flex-row align-items-center mb-2">
                  ...
                  <div class="text-start">
                    <button type="submit" name="login" class="btn btn-danger w-100">Log in</button>
                  </div>
