...
$user = tampil_user("SELECT * FROM users WHERE id_users = $id_user")[0];
...
if (isset($_POST["ubah"])) {
	...
	document.location.href = 'user.php';
        ...
        echo "<script>alert('user Gagal di Ubah');
	</script>";
    }
}
?>
            ...
            <div class="row">
                ...
                <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <span id="iddivisi" class="form-text">Kode User</span>
                            <input type="text" class="form-control" value="<?= $user["id_users"]; ?>" name="id_user" readonly>
                            <span id="namadivisi" class="form-text">Username</span>
                            <input type="text" class="form-control" id="username" aria-describedby="emailHelp" value="<?= $user["username"]; ?>" name="username" required>
                            <br>
                            <span id="namadivisi" class="form-text">Password</span>
                            <input type="password" class="form-control" id="password" aria-describedby="emailHelp" value="<?= $user["passwords"]; ?>" name="password" required>
                            <br>
                            <span id="namadivisi" class="form-text">Nama</span>
                            <input type="text" class="form-control" id="name" aria-describedby="emailHelp" value="<?= $user["nama"]; ?>" name="name" required>
                            <br>
                            <span id="namadivisi" class="form-text">Divisi</span>
                            <select class="form-select" id="divisi" aria-label="Floating label select example" name="divisi">
                                <?php
                                foreach ($divisi as $dvs) : ?>
                                <?php
                                if ($dvs["id_divisi"] == $user["id_divisi"]){
                            ...
                            <br>
                            <span id="namadivisi" class="form-text">Role</span>
                            <select class="form-select" id="role" aria-label="Floating label select example" name="role">
                                ...
                                <?php
                                if ($rll == $user["role"]){
                                ?> <option selected="selected" value="<?= $rll; ?>"><?= $rll; ?></option> 
                               <?php } else { ?>
                            ...
                            <a href="user.php" class="btn btn-outline-danger"><i class="bi bi-x-circle"></i> Cancel</a>
                        </div>
                    </div>
