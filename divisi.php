...
$jumlahdata = 10;
$jumlahdivisi = count(tampil_divisi("SELECT * FROM divisi"));
$jumlahhal = ceil($jumlahdivisi / $jumlahdata);
...
$divisi = tampil_divisi("SELECT * FROM divisi LIMIT $awaldata, $jumlahdata");

if (isset($_POST["textcari"])) {

  $divisi = cari_divisi($_POST["textcari"]);
}
  ...
  <form method="post" action="">
    <header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
      ...
      <form action="" method="post">
        <input type="text" class="form-control form-control-dark w-100 rounded-0 border-0" placeholder="Cari Divisi" name="textcari">
      </form>
    ...
    <div class="container-fluid">
      ...
      <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
          ...
          <a class="btn btn-outline-primary" role="button" href="tambahdivisi.php"><i class="bi bi-plus-lg"></i> Tambah Divisi</a>
          <p>
    ...
    <table class="table table-bordered">
      <thead>
        <tr>
          ...
          <th class="text-center" scope="col">Kode Divisi</th>
      ...
      foreach ($divisi as $dvs) : ?>
        ...
        <tbody>
          <tr>
            ...
            <td class="text-center"><?= sprintf("%03d", $dvs["id_divisi"]); ?></td>
            <td class="text-center"><?= $dvs["nama_divisi"]; ?></td>
            <td class="text-center">
              <a class="btn btn-outline-success" role="button" href="ubahdivisi.php?id_divisi=<?= $dvs["id_divisi"]; ?>"><i class="bi bi-pencil-square"></i></a>
              <button type="button" class="btn btn-outline-danger" data-bs-toggle="modal" data-bs-target="#deleteModal<?= $dvs['id_divisi']; ?>"><i class="bi bi-trash3-fill"></i></button>
            </td>
        </tbody>
        <?php $no++; ?>

        <!-- Modal Delete -->
        <div class="modal fade" id="deleteModal<?= $dvs['id_divisi']; ?>"" tabindex=" -1" aria-labelledby="tambahDivisi" aria-hidden="true">
          <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="tambahDivisi">Hapus Divisi </h5>
              ...
              <div class="modal-footer">
                <a class="btn btn-outline-danger" href="hapusdivisi.php?id=<?= $dvs["id_divisi"]; ?>"><i class='bi bi-trash3-fill'></i> Hapus</a>
